...
class VCBaseViewController: UIViewController, VCViewControllerRequestContentProtocol {
    ...
    // 刷新内容（需要有一个Loading状态，并且界面可能需要滚动到顶部）
    func refreshContent(_ isRefresh: Bool = true) {
        
    }

    func pageContainerChildVCWillAppear() {
